...
{
    /// <summary>
    /// Orchestre la navigation globale de l'interface utilisateur et la gestion des fenêtres.
    /// Maintient une pile (Stack) de menus actifs pour gérer l'historique de navigation et les superpositions (Popups).
    /// </summary>
